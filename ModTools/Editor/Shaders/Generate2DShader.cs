...
namespace ModTools
{
    internal class Generate2DShader
    {
        private static readonly string shaderPath = "Assets/GeneratedShaders/LuxShader.shader";

        [MenuItem("KSP2 ModTools/LuxShader")]
        public static void CreateOrApply2DTextureShader()
        {

            bool userWantsShader = EditorUtility.DisplayDialog("Shader Missing",
                "The LuxShader does not exist. Would you like to generate it?",
                "Yes", "No");
        ...
        private static bool ShaderExists()
        {
        ...
        private static void GenerateShader()
        {
            ...
            EditorUtility.DisplayDialog("Success", "LuxShader added successfully!", "OK");
        }

        public static void Create2DTextureShader()
        {
            {
                string shaderContent = @"Shader ""ModTools/LuxShader""
{
    Properties
    {
    ...
    FallBack ""Diffuse""
                ...
                string path = "Assets/GeneratedShaders/LuxShader.shader";
                Directory.CreateDirectory("Assets/GeneratedShaders");
